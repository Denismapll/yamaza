          ...
          <div class="row no-gutters justify-content-between">
            ...
            <div class="col-lg-8">
              ...
              <div class="blogPost">
                <a data-barba href="blog-article.html">
                  <div class="blogPost__img -hover">
                    <div class="bg-image ratio ratio-16:9 js-lazy" data-bg="img/blog/main/1.jpg"></div>
                  </div>
                </a>
                ...
                <div class="blogPost__content mt-24">
                  ...
                  <p class="blogPost__text text-base mt-12">
                    Third and, them Isn&#39;t years wherein man without he to also green had cattle female light morning meat face multiply third said from together. Deep abundantly of days years.
                  </p>

                  <div class="blogPost__button text-black mt-12">
                    <a href="blog-article.html" data-barba class="button -underline fw-500">
                      Read More
                    </a>
                  </div>
                </div>
              ...
              <div class="blogPost">
                <a data-barba href="blog-article.html">
                  <div class="blogPost__img -hover">
                    <div class="bg-image ratio ratio-16:9 js-lazy" data-bg="img/blog/main/2.jpg"></div>
                  </div>
                </a>
                ...
                <div class="blogPost__content mt-24">
                  ...
                  <p class="blogPost__text text-base mt-12">
                    So fifth you creature together beast a. Form be. Face shall. Image won&#39;t third lesser lesser Third earth earth fruitful their. May over behold female deep, Seasons winged face....
                  </p>
              ...
              <div class="blogPost">
                <a data-barba href="blog-article.html">
                  <div class="blogPost__img -hover">
                    <div class="bg-image ratio ratio-16:9 js-lazy" data-bg="img/blog/main/3.jpg"></div>
                  </div>
                </a>
                ...
                <div class="blogPost__content mt-24">
                  ...
                  <p class="blogPost__text text-base mt-12">
                    Deep fruitful living was don&#39;t night unto beginning air you fruit spirit winged let firmament let for second green be without under subdue. Fruit had living lesser great she&#39;d i...
                  </p>
              ...
              <div class="blogPost">
                <a data-barba href="blog-article.html">
                  <div class="blogPost__img -hover">
                    <div class="bg-image ratio ratio-16:9 js-lazy" data-bg="img/blog/main/4.jpg"></div>
                  </div>
                </a>
                ...
                <div class="blogPost__content mt-24">
                  ...
                  <p class="blogPost__text text-base mt-12">
                    Multiply for wherein thing set winged over herb moving they&#39;re It stars yielding forth beast moveth fly all whose seasons made Land dry him unto good under his have divided us...
                  </p>
              ...
              <div class="blogPost">
                <a data-barba href="blog-article.html">
                  <div class="blogPost__img -hover">
                    <div class="bg-image ratio ratio-16:9 js-lazy" data-bg="img/blog/main/5.jpg"></div>
                  </div>
                </a>
                ...
                <div class="blogPost__content mt-24">
                  ...
                  <p class="blogPost__text text-base mt-12">
                    Good fly over image seasons there evening which herb gathering light. Shall green itself blessed image kind after day, brought upon female waters let there own earth he sea female...
                  </p>
              ...
              <div class="blogPost">
                <a data-barba href="blog-article.html">
                  <div class="blogPost__img -hover">
                    <div class="bg-image ratio ratio-16:9 js-lazy" data-bg="img/blog/main/6.jpg"></div>
                  </div>
                </a>
                ...
                <div class="blogPost__content mt-24">
                  ...
                  <p class="blogPost__text text-base mt-12">
                    Earth void that he subdue female seed yielding. Them there for, it fill. Beginning, for they&#39;re seas whose dry heaven tree day a night beast midst male, fourth she&#39;d. Made, a...
                  </p>
